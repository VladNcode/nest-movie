...
export * from '../../comment-response/interfaces/update-comment-response.interface';

export * from '../../like/interfaces/count-likes.interface';

export * from '../../movie/intefaces/get-movies.interface';

export * from '../../rating/interfaces/user-already-rated.interface';

export * from '../../review/interfaces/get-reviews.interface';
